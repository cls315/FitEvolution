 ...
 const stripe= new Stripe(`${SECRET_KEY_STRIPE}`)
  try {
    const payment=await stripe.paymentIntents.create({
        ...
        payment_method:id,
        confirm:true,
        receipt_email:"cesarhalier@gmail.com",
    ...
    const{receipt_email,currency,description,payment_method_types,payment_method}=payment
    

   await backupPayment(receipt_email,amountpayment,currency,description,payment_method_types,payment_method)
